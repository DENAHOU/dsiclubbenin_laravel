    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background: linear-gradient(180deg, #f6f7f8 0%, #fafcfc 100%); box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        <div class="container-fluid px-4">
            ...
            <a class="fw-bold" href="#" style="color: #094281; font-size: 1.3rem; text-decoration: none; font-weight: bold;">
                <i class="fas fa-briefcase me-2" style="color: #094281;"></i> Club DSI - Administration Publique
            </a>
        </div>
    </nav>
            ...
            <div class="col-md-9">
                <div class="content-area">
                    ...
                    <div class="card-header-dsi">
                            <i class="fas fa-info-circle me-2"></i> Informations de l'Administration
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <p><strong>Nom :</strong> {{ $administration->name }}</p>
                                    <p><strong>Type d'Entité :</strong> {{ $administration->entity_type }}</p>
                                    <p><strong>Adresse :</strong> {{ $administration->address }}</p>
                                    <p><strong>Site Web :</strong>
                                        @if($administration->website_url)
                                            <a href="{{ $administration->website_url }}" target="_blank">{{ $administration->website_url }}</a>
                                        @else
                                            Non spécifié
                                        @endif
                                    </p>
                                ...
                                <div class="col-md-6">
                                    <p><strong>Contact :</strong> {{ $administration->contact_name }}</p>
                                    <p><strong>Poste :</strong> {{ $administration->contact_position }}</p>
                                    <p><strong>Email Contact :</strong> {{ $administration->contact_email }}</p>
                                    <p><strong>Téléphone Contact :</strong> {{ $administration->contact_phone }}</p>
                                </div>
                            </div>
                            <div class="text-end mt-3">
                                <a href="{{ route('administration.edit', $administration->id) }}" class="btn btn-outline-secondary">
                    ...
                    {{-- <div class="row g-4">
                        <div class="col-md-6">
                            <div class="card card-dsi">
                                <div class="card-header-dsi">
                                    <i class="fas fa-newspaper me-2"></i> Dernières Nouvelles du Club DSI
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Restez informé des actualités, événements et opportunités.</p>
                        ...
                        <div class="col-md-6">
                            <div class="card card-dsi">
                                ...
                                <div class="card-body">
                                    <p class="card-text">Découvrez les prochains ateliers, séminaires et conférences.</p>
                                    <a href="#" class="btn btn-sm btn-outline-success">Consulter l'agenda</a>
                                </div>
                            </div>
                        </div>
                    </div> --}}
