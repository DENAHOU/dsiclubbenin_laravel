...
@section('title', 'Paramètres du Compte - Administration Publique')
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background: linear-gradient(180deg, #f6f7f8 0%, #fafcfc 100%); box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        <div class="container-fluid px-4">
            <a class="fw-bold" href="#" style="color: #094281; font-size: 1.3rem; text-decoration: none; font-weight: bold;">
                <i class="fas fa-briefcase me-2" style="color: #094281;"></i> Club DSI - Paramètres du Compte
            </a>
        </div>
    </nav>
    ...
    <div class="container-fluid mt-4 mb-4">
        <div class="settings-container">
            ...
            <div class="settings-header">
                <h1>
                    <i class="fas fa-cogs"></i> Paramètres du Compte
                </h1>
            </div>
            ...
            <div class="settings-content">
                ...
                <div class="settings-section">
                    ...
                    <form action="{{ route('administration.update-password', $administration->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                ...
                <div class="settings-section">
                    ...
                    <p class="section-description" style="color: #721c24;">
    ...
    <div id="deleteModal" class="modal-delete">
        <div class="modal-content-delete">
            ...
            <div class="modal-buttons">
                ...
                <form action="{{ route('administration.delete-account', $administration->id) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
