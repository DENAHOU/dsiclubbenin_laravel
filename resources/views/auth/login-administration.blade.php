...
<body>
    <div class="auth-container">
        <div class="auth-box">
            ...
            <h2 class="form-title">Espace Administration Publique</h2>
            <p class="form-subtitle">Connectez-vous à votre espace dédié.</p>
        ...
        <div class="social-divider">OU</div>
            ...
            <form method="POST" action="{{ route('login.administration') }}">
                @csrf
                
                <div class="form-group">
                    <i class="fas fa-envelope"></i>
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus class="form-control" placeholder="E-mail de l'administration">
                </div>
