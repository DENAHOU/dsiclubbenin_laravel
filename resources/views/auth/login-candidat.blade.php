...
<head>
    <meta charset="UTF-8">
    <title>Connexion Espace Candidat</title>
...
<body>
    <div class="auth-container">
        <div class="auth-box">
            ...
            <p class="form-subtitle">Suivez vos candidatures et gérez votre profil talent.</p>

            @if($errors->any())<div class="alert alert-danger">{{ $errors->first('email') }}</div>@endif

            <form method="POST" action="{{ route('login.candidat') }}">
                @csrf
