...
<head>
    ...
    <title>Connexion Espace Entreprise Membre</title>
...
<body>
    <div class="auth-container">
        <div class="auth-box">
            ...
            <h2 class="form-title">Espace Entreprise Membre</h2>
            <p class="form-subtitle">Connectez-vous pour gérer le profil de votre organisation.</p>
        ...
        <div class="social-divider">OU</div>
            ...
            <form method="POST" action="{{ route('login.company') }}" >
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus class="form-control" placeholder="E-mail de l'entreprise">
                </div>
