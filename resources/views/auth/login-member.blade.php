...
<body>
    <div class="auth-box">
        ...
        <a href="{{ route('login.microsoft.redirect') }}" class="btn btn-primary d-block mb-3">
        ...
        <form method="POST" action="{{ route('login.member') }}">
            ...
            <div class="form-group">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus class="form-control" placeholder="E-mail">
            </div>
