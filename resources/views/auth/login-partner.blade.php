...
<head>
    <meta charset="UTF-8">
    <title>Connexion Espace Partenaire</title>
...
<body>
    <div class="auth-container">
        <div class="auth-box">
            ...
            <h2 class="form-title">Espace Partenaire</h2>
            <p class="form-subtitle">Accédez à votre tableau de bord et à vos ressources exclusives.</p>
