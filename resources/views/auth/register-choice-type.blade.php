...
<div class="membership-grid">
    ...
    <div class="membership-card">
        ...
        <div class="card-footer text-center">
            ...
            <a href="{{ route('register.membre') }}?type=individuel" class="btn btn-select mt-2">Choisir ce Statut</a>
        </div>
    </div>
    ...
    <div class="membership-card">
        ...
        <div class="card-footer text-center">
            ...
            <a href="{{ route('register.company') }}?type=entite" class="btn btn-select mt-2">Choisir ce Statut</a>
        </div>
    </div>
    ...
    <div class="membership-card">
        ...
        <div class="card-footer text-center">
             <a href="{{ route('register.admin') }}?type=admin_publique" class="btn btn-select mt-2">Choisir ce Statut</a>
        </div>
    </div>
    ...
    <div class="membership-card">
        ...
        <div class="card-footer text-center">
            ...
            <a href="{{ route('register.college_it') }}?type=college_it" class="btn btn-select mt-2">Choisir ce Statut</a>
        </div>
    </div>
</div>
