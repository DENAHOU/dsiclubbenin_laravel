    ...
    <main class="register-hub-container">
        ...
        <div class="profiles-grid">
            ...
            <div class="profile-card highlight">
                ...
                <a href="{{ route('register.membre.conditions') }}" class="btn-select-profile text-white">Devenir Membre</a>
            </div>
            ...
            <div class="profile-card">
                ...
                <a href="{{ route('register.candidat') }}" class="btn-select-profile">Créer mon Profil Candidat</a>
            </div>
            ...
            <div class="profile-card">
                ...
                <a href="{{ route('register.esn') }}" class="btn-select-profile">Créer un Compte Entreprise</a>
            </div>
            ...
            <div class="profile-card">
                ...
                <p>Publiez vos offres, découvrez des talents qualifiés ou enregistrez votre ESN pour gagner en visibilité et développer votre business.</p>
                <a href="{{ route('register.partner') }}" class="btn-select-profile">Créer un Compte Entreprise</a>
            </div>
            ...
            <div class="profile-card">
                ...
                <p>Publiez vos offres, découvrez des talents qualifiés ou enregistrez votre ESN pour gagner en visibilité et développer votre business.</p>
                <a href="{{ route('register.recruter') }}" class="btn-select-profile">Créer un Compte Entreprise</a>
            </div>
        </div>
    </main>
