...
<div class="shared-resources-section">
    ...
    <div class="row g-3">
        <!-- Formations -->
        <div class="col-md-4">
            <a href="{{ route($userType . '.formations') }}" class="resource-card">
        ...
        <div class="col-md-4">
            <a href="{{ route($userType . '.annuaire.membres') }}" class="resource-card">
                <div class="resource-icon">
        ...
        <div class="col-md-4">
            <a href="{{ route($userType . '.annuaire.partenaires') }}" class="resource-card">
                <div class="resource-icon">
