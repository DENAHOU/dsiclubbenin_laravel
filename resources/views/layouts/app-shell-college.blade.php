    ...
    <aside class="sidebar">
        <div>
            ...
            <ul class="sidebar-nav">
                <li class="nav-item"><a href="{{ route('college.dashboard') }}" class="nav-link active"><i class="fas fa-home"></i> Espace de travail</a></li>
                ...
                <li class="nav-item"><a href="{{ route('college.profil', Auth::guard('college')->user()->id) }}" class="nav-link"><i class="fas fa-id-card"></i> Mon Profil</a></li>
                <li class="nav-item"><a href="{{ route('college.edit', Auth::guard('college')->user()->id) }}" class="nav-link"><i class="fas fa-edit"></i> Modifier mon Profil</a></li>
                <li class="nav-item"><a href="{{ route('college.settings', Auth::guard('college')->user()->id) }}" class="nav-link"><i class="fas fa-cogs"></i> Paramètres</a></li>
