    ...
    <aside class="sidebar">
        <div>
            ...
            <ul class="sidebar-nav">
                <li class="nav-item"><a href="{{ route('company.dashboard') }}" class="nav-link active"><i class="fas fa-home"></i> Espace de travail</a></li>
                ...
                <li class="nav-item">
                    <a href="{{ route('company.profil', Auth::guard('company')->user()->id) }}" class="nav-link">
                        <i class="fas fa-briefcase"></i> Mon Profil
                    </a>
                </li>

                <li class="nav-item">
                    <a href="{{ route('company.edit', Auth::guard('company')->user()->id) }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('company.settings', Auth::guard('company')->user()->id) }}" class="nav-link">
