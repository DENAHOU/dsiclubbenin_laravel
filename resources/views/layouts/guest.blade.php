            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="d-none d-lg-flex align-items-center gap-2 ms-3">
                        ...
                        <a href="{{ route('login') }}" class="btn btn-cta-secondary px-3"><i class="fas fa-sign-in-alt me-2"></i>Se Connecter</a>
                        <a href="{{ route('register') }}" class="btn btn-cta-primary px-3">Devenir Membre</a>
                    </div>
                </div>
        </nav>
    ...
    <div class="container">
        ...
        <div class="footer-top">
            ...
            <div class="footer-about footer-logo">
                <img src="{{ asset('img/logo.png') }}" alt="Logo Club DSI Bénin">
