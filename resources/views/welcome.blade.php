            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        ...
                        {{-- {{-- JE VEUX UTILISER LA FONCTION typewriter POUR LE TITRE PRINCIPAL,  --}}
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="position-relative">
                    <img class="img-fluid w-100 rounded" src="{{ asset('img/img.jpg') }}" alt="Session de formation">
                </div>
            </div>
            ...
            <div class="col-lg-6 wow slideInRight" data-wow-delay="0.6s">
                ...
                <a href="{{ route('activites.formations') }}" class="btn btn-primary py-3 px-5 mt-5" style="background-color: var(--dsi-blue-dark); color: white;">Explorer le Catalogue</a>
            </div>
        </div>
    </div>
</section>
