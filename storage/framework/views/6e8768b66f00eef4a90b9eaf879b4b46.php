<?php $__env->startSection('title', 'Nos Partenaires'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        ...
        .hero-partners::before {
            ...
            inset: 0;
            z-index: 0;
            background-image: url("<?php echo e(asset('img/IMG_1929.jpg')); ?>"); /* Assurez-vous que le chemin est correct */
    ...
    <div id="main-partners-section"> <!-- Ancre pour le CTA du héros -->
        ...
        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($type->partners->count()): ?>

                <section class="partners-category-section animated-section">
                    <div class="container">
                        <div class="category-header">
                            <h3>Nos Partenaires <?php echo e($type->name); ?></h3>
                            <?php if($type->id == 1): ?> 
                        ...
                        <?php if($type->id == 1): ?> 
                            <div class="institutions-carousel-wrapper">
                                <?php $__currentLoopData = $type->partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="institution-card">
                                        <?php if($partner->website_url): ?>
                                            <a href="<?php echo e($partner->website_url); ?>" target="_blank" class="partner-link"></a>
                                        <?php endif; ?>
                                        <img src="<?php echo e(asset('storage/'.$partner->logo_path)); ?>" alt="<?php echo e($partner->company_name); ?>">
                                        <span class="partner-name"><?php echo e($partner->company_name); ?></span>
                                    </div>
    ...
    <section class="cta-section animated-section">
        <div class="cta-container">
            <div class="cta-card primary">
                ...
                <a href="<?php echo e(route('register.partner')); ?>" class="btn">Postuler au Partenariat</a>
            </div>
            <div class="cta-card secondary">
                ...
                <a href="<?php echo e(route('login.partner')); ?>" class="btn">Accéder à la Plateforme</a>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/club/partners.blade.php ENDPATH**/ ?>