<?php $__env->startSection('title', 'ESN'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        ...
        .hero-esn-banner {
            ...
            background-image: linear-gradient(#101d34bd), url("<?php echo e(asset('img/IMG_1966.jpg')); ?>");
...
<!-- ================= ACTE III : L'EXPLORATION ================= -->
    ...
    <?php $__currentLoopData = $esns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $esn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <div class="esn-card">

            <div class="esn-logo">
                <img
                    src="<?php echo e($esn->logo_path
                        ? asset('storage/'.$esn->logo_path)
                        : asset('images/default-company.png')); ?>"
                    alt="<?php echo e($esn->company_name); ?>"
                >
            </div>
            ...
            <div class="esn-info">
                ...
                <div class="d-flex justify-content-between align-items-start">
                    ...
                    <span class="esn-tag badge" style="background-color: <?php echo e($tagClass); ?>;">
                        <?php echo e($esn->esn_type); ?>
                ...
                <p class="esn-desc">
                    <?php echo e(Str::limit($esn->description, 120)); ?>

                </p>

                <div class="esn-meta">
                    <i class="fas fa-map-marker-alt me-1 text-danger"></i>
                    <?php echo e($esn->location); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <div class="d-flex justify-content-center mt-4">
            <?php echo e($esns->links('pagination::simple-bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/pages/esn.blade.php ENDPATH**/ ?>