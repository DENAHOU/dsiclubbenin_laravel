...
<body>
    ...
    <div class="form-wizard-container">
        ...
        <form action="<?php echo e(route('register.partner.store')); ?>" method="POST" id="partner-form" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-wizard-content">
                ...
                <div class="form-step">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12"><label class="form-label">Type de partenaire *</label><select name="partner_type_id" class="form-select" required><option value="" selected disabled>Choisissez...</option><?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($type->id); ?>"><?php echo e($type->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>

                        <div class="col-12"><label class="form-label">Formule de partenariat *</label><select name="partner_formule_id" class="form-select" required><option value="" selected disabled>Choisissez...</option><?php $__currentLoopData = $formules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($formule->id); ?>"><?php echo e($formule->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
...
<?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/auth/register-partner.blade.php ENDPATH**/ ?>