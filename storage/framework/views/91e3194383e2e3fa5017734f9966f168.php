...
<?php $__env->startSection('title', 'Protection de données'); ?>
            ...
            <div class="policy-content">
                ...
                <div style="text-align: justify; line-height: 1.8; color: #333;">
                    ...
                    <p class="mb-4">
                        ...
                        <a href="<?php echo e(route('home')); ?>" style="color: #094281; font-weight: 500;">CGU</a>.
                    </p>
                    <p class="mb-4">
                    ...
                    <p class="mb-4">
                        ...
                        l'adresse <a href="<?php echo e(route('contact')); ?>" style="color: #094281; font-weight: 500;">Contactez-nous</a> 
        ...
        <div class="col-lg-3 mt-5 mt-lg-0">
            <div style="background: #f8f9fa; padding: 1.5rem; border-radius: 10px; position: sticky; top: 100px;">
                ...
                <div style="margin-top: 2rem; padding: 1rem; background: linear-gradient(135deg, #094281 0%, #0a2b5c 100%); border-radius: 8px; text-align: center;">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-sm" style="background-color: #ffc107; color: #094281; font-weight: 600; border: none;">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/politique/protection-donnees.blade.php ENDPATH**/ ?>