<?php $__env->startSection('title', 'Annuaire des Membres'); ?>
...
<div class="container-fluid py-4">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="filter-tabs">
                        ...
                        <a href="?type=users" class="filter-tab <?php echo e($type == 'users' ? 'active' : ''); ?>">
                            <i class="fas fa-user me-2"></i>Membres
                        </a>
                        <a href="?type=company" class="filter-tab <?php echo e($type == 'company' ? 'active' : ''); ?>">
                            <i class="fas fa-building me-2"></i>Entreprises
                        </a>
                        <a href="?type=college" class="filter-tab <?php echo e($type == 'college' ? 'active' : ''); ?>">
                            <i class="fas fa-graduation-cap me-2"></i>Collèges
                        </a>
                        <a href="?type=administration" class="filter-tab <?php echo e($type == 'administration' ? 'active' : ''); ?>">
                ...
                <div class="col-lg-4">
                    <div class="search-box">
                        <input type="text" name="search" class="search-input" placeholder="Rechercher un membre..." value="<?php echo e($search); ?>">
    ...
    <?php if($membres->count() > 0): ?>
        <div class="member-grid">
            <?php $__currentLoopData = $membres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="member-card">
                    <!-- Avatar -->
                    <div class="member-avatar-container">
                        <?php if($member['photo_path']): ?>
                            <img src="<?php echo e(asset('storage/' . $member['photo_path'])); ?>" 
                                 class="member-avatar" 
                    ...
                    <div class="member-info">
                        ...
                        <span class="member-type 
                            <?php echo e($member['type'] == 'user' ? 'type-user' : ''); ?>

                            <?php echo e($member['type'] == 'company' ? 'type-company' : ''); ?>

                            <?php echo e($member['type'] == 'college' ? 'type-college' : ''); ?>

                            <?php echo e($member['type'] == 'administration' ? 'type-admin' : ''); ?>">
                            <?php echo e($member['type_display']); ?>
                        ...
                        <div class="member-details">
                            ...
                            <?php if($member['current_employer']): ?>
                                <div class="member-detail-item">
                                    <i class="fas fa-building"></i>
                                    <span><?php echo e($member['current_employer']); ?></span>
                                </div>
                            <?php endif; ?>

                            <?php if($member['sector']): ?>
                                <div class="member-detail-item">
                                    <i class="fas fa-briefcase"></i>
                                    <span><?php echo e($member['sector']); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="member-actions">
                            <button onclick="copyContactInfo('<?php echo e($member['email']); ?>', '<?php echo e($member['name']); ?>')" class="action-btn btn-secondary-custom">
        ...
        <div class="d-flex justify-content-center mt-4">
            <?php if($membres->currentPage() > 1): ?>
                <a href="<?php echo e($membres->previousPageUrl()); ?>" class="btn-pagination">
                    <i class="fas fa-chevron-left me-2"></i>Précédent
                </a>
            <?php endif; ?>
            
            <?php if($membres->hasMorePages()): ?>
                <a href="<?php echo e($membres->nextPageUrl()); ?>" class="btn-pagination">
...
<?php echo $__env->make('layouts.app-shell-' . ($userType === 'company' ? 'entite' : ($userType === 'college' ? 'college' : ($userType === 'administration' ? 'administration' : 'admin'))), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/shared/annuaire-membres.blade.php ENDPATH**/ ?>