<?php $__env->startSection('title', 'Evenements-Actualités'); ?>
            ...
            <div class="carousel-inner">
                <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item <?php echo e($loop->first ? 'active' : ''); ?>">
                        <img class="w-100" src="<?php echo e(asset($slide['image'])); ?>" alt="<?php echo e($slide['alt']); ?>">
            ...
            <?php if($events->count() > 0): ?>
                <section class="new-events-section">
                    ...
                    <div class="filter-buttons">
                        ...
                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $eventsByType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($type !== 'autre'): ?>
                                <button class="filter-btn" data-filter-new="<?php echo e($type); ?>"><?php echo e(ucfirst($type)); ?></button>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="events-grid" id="new-events-grid">
                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $eventsByType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $eventsByType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="event-card" data-category-new="<?php echo e($type); ?>">
                                    <div class="card-media">
                                        <?php if($event->image): ?>
                                            <img src="<?php echo e(asset($event->image)); ?>" alt="<?php echo e($event->titre); ?>">
                                        <?php elseif($event->video_url): ?>
                                            <iframe src="<?php echo e($event->video_url); ?>" allowfullscreen></iframe>
                                    ...
                                    <div class="card-content">
                                        <span class="card-tag" style="background-color: <?php echo e($event->typeEvent ? $event->typeEvent->couleur : '#95a5a6'); ?>;">
                                            <?php echo e($event->typeEvent ? $event->typeEvent->nom : 'Événement'); ?>

                                        </span>
                                        <a href="#" class="card-title"><?php echo e($event->titre); ?></a>
                                        <?php if($event->date): ?>
                                            <div class="card-footer">
                                                ...
                                                <?php if($event->location): ?>
                                                    <br><i class="fas fa-map-marker-alt me-1"></i> <?php echo e($event->location); ?>
            ...
            <section class="premium-section">
                ...
                <div class="premium-content">
                    ...
                    <div class="premium-image">
                        <img src="<?php echo e(asset('img/dsi.jpg')); ?>" alt="dsi awards">
                    </div>
                </div>
            </section>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/activites/evenements.blade.php ENDPATH**/ ?>