<?php $__env->startSection('title', 'Programmes Thématiques'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        ...
        .hero-themes {
            ...
            background-image: linear-gradient(#101d34bd), url("<?php echo e(asset('img/image.jpg')); ?>");
                            ...
                            <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="excellence-card">
                                    <div class="excellence-icon">
                                        <i class="<?php echo e($program->display_icon); ?>"></i>
                                    </div>
                                    <h3 class="excellence-title"><?php echo e($program->titre); ?></h3>
                                    <p class="excellence-description"><?php echo e($program->description); ?></p>
                                    <div class="excellence-meta">
                                        <span class="excellence-date">
                                            <i class="fas fa-calendar-alt me-1"></i>
                                            <?php echo e(\Carbon\Carbon::parse($program->created_at)->format('d/m/Y')); ?>

                                        </span>
                                        <span class="excellence-status">
                                            <?php echo e($program->status == 'actif' ? 'Actif' : 'Inactif'); ?>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/club/programme.blade.php ENDPATH**/ ?>