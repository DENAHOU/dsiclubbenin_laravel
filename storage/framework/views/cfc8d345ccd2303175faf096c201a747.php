            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="<?php echo e(asset('img/logo-dsi.png')); ?>"alt="Logo Club DSI Bénin"class="block " style="width: 100px; height: 50px;" />
                    </a>
                </div>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
         <?php $__env->slot('trigger', null, []); ?> 
            <?php
                // Détection automatique du bon utilisateur selon le guard
                $user = Auth::guard('web')->user()
                    ?? Auth::guard('company')->user()
                    ?? Auth::guard('college')->user()
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <?php
                // On récupère l'utilisateur connecté peu importe le guard
                $user = Auth::guard('web')->user()
                    ?? Auth::guard('company')->user()
                    ?? Auth::guard('college')->user()
                    ?? Auth::guard('administration')->user()
...
<?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>