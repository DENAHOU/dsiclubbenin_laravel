...
<div class="footer-top">
    ...
    <div class="footer-col">
        ...
        <ul>
            ...
            <li><a href="<?php echo e(route('club.about')); ?>">Nos missions</a></li>
            <li><a href="<?php echo e(route('club.about')); ?>">Nos valeurs</a></li>
            <li><a href="<?php echo e(route('club.about')); ?>">Notre histoire</a></li>
        </ul>
    </div>
            ...
            <div class="chatbot-body" id="chatbot-body">
                ...
                <div class="faq-questions" id="faq-questions">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <button class="faq-btn" data-faq-id="<?php echo e($faq->id); ?>"><?php echo e($faq->title); ?></button>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const faqs = <?php echo json_encode($faqs->keyBy('id'), 15, 512) ?>;
