                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center bg-white h-100">
                            ...
                            <a class="btn btn-lg btn-primary rounded" href="<?php echo e(route('activites.formations')); ?>" style="background-color:#0a2b5c;">
                    ...
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center bg-white h-100">
                            ...
                            <a class="btn btn-lg btn-primary rounded" href="<?php echo e(route('activites.evenements')); ?>" style="background-color:#0a2b5c;">
                                <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
...
<section class="skills-platform-section">
    ...
    <section class="forum-section">
        ...
        <div class="forum-wrap">
            ...
            <div class="forum-presentation">
                ...
                <div class="forum-cta">
                    <a class="btn primary" href="<?php echo e(route('nexusdsi.coming-soon')); ?>">Aller sur NexusDSI Hub</a>
                </div>
            </div>
    ...
    <section class="cta-section-v2">
        ...
        <div class="cta-content">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-cta-final">Adhérer Maintenant</a>
        </div>
    </section>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/welcome.blade.php ENDPATH**/ ?>