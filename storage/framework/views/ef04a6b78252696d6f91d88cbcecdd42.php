...
<div class="container my-5">
    <div class="register-form-box shadow-lg p-4 rounded-4 bg-white">
        ...
        <form action="<?php echo e(route('register.membre.store')); ?>" method="POST" id="multiStepForm" class="needs-validation" enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select <?php $__errorArgs = ['sexe'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('birthday')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control <?php $__errorArgs = ['medias_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="file" name="medias_id" id="photoInput" accept="image/*" required>
                        <?php $__errorArgs = ['medias_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
            ...
            <div class="form-step" id="step-2">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="current_employer" class="form-control <?php $__errorArgs = ['current_employer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('current_employer')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="employer_contact" class="form-control <?php $__errorArgs = ['employer_contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('employer_contact')); ?>" required>
                        <?php $__errorArgs = ['employer_contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="current_position" class="form-select <?php $__errorArgs = ['current_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="">Choisir...</option>
                            <option <?php echo e(old('current_position') == "Directeur des Systèmes d'Information (DSI)" ? 'selected' : ''); ?>>Directeur des Systèmes d'Information (DSI)</option>
                            <option <?php echo e(old('current_position') == "Responsable des Systèmes d'Information (RSI)" ? 'selected' : ''); ?>>Responsable des Systèmes d'Information (RSI)</option>
                            <option <?php echo e(old('current_position') == "Responsable de la Sécurité des SI (RSSI)" ? 'selected' : ''); ?>>Responsable de la Sécurité des SI (RSSI)</option>
                            <option <?php echo e(old('current_position') == "Directeur Technique (DT)" ? 'selected' : ''); ?>>Directeur Technique (DT)</option>
                            <option <?php echo e(old('current_position') == "Responsable Technique (RT)" ? 'selected' : ''); ?>>Responsable Technique (RT)</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="sector" id="sectorSelect" class="form-select <?php $__errorArgs = ['sector'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="">Choisir...</option>
                            <option value="Public" <?php echo e(old('sector') == 'Public' ? 'selected' : ''); ?>>Public</option>
                            <option value="Privé" <?php echo e(old('sector') == 'Privé' ? 'selected' : ''); ?>>Privé</option>
                            <option value="Multinationale" <?php echo e(old('sector') == 'Multinationale' ? 'selected' : ''); ?>>Multinationale</option>
                            <option value="Organisme international" <?php echo e(old('sector') == 'Organisme international' ? 'selected' : ''); ?>>Organisme international</option>
                            <option value="ONG" <?php echo e(old('sector') == 'ONG' ? 'selected' : ''); ?>>ONG</option>
                            <option value="Autre" <?php echo e(old('sector') == 'Autre' ? 'selected' : ''); ?>>Autre</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6" id="sectorOtherDiv" style="display: none;">
                        ...
                        <input type="text" name="sector_other" id="sectorOtherInput" class="form-control <?php $__errorArgs = ['sector_other'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sector_other')); ?>">
                        <?php $__errorArgs = ['sector_other'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="category_of_service" id="categorySelect" class="form-select <?php $__errorArgs = ['category_of_service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="">Choisir...</option>
                            <option value="Industrie" <?php echo e(old('category_of_service') == 'Industrie' ? 'selected' : ''); ?>>Industrie</option>
                            <option value="Banque" <?php echo e(old('category_of_service') == 'Banque' ? 'selected' : ''); ?>>Banque</option>
                            <option value="Autre" <?php echo e(old('category_of_service') == 'Autre' ? 'selected' : ''); ?>>Autre</option>
                        </select>
                        <?php $__errorArgs = ['category_of_service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6" id="categoryOtherDiv" style="display: none;">
                        ...
                        <input type="text" name="category_other" id="categoryOtherInput" class="form-control <?php $__errorArgs = ['category_other'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('category_other')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="area_of_expertise" class="form-control <?php $__errorArgs = ['area_of_expertise'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('area_of_expertise')); ?>" required>
                        <?php $__errorArgs = ['area_of_expertise'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="initial_training" class="form-control <?php $__errorArgs = ['initial_training'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('initial_training')); ?>" required>
                        <?php $__errorArgs = ['initial_training'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="type_members" id="type_members" class="form-control" required>
                            ...
                            <option value="individuel" <?php echo e($type == 'individuel' ? 'selected' : ''); ?>>Membre Individuel</option>

                            <option value="entite" <?php echo e($type == 'entite' ? 'selected' : ''); ?>>Entité Utilisatrice</option>

                            <option value="admin_publique" <?php echo e($type == 'admin_publique' ? 'selected' : ''); ?>>Administration Publique</option>

                            <option value="it" <?php echo e($type == 'it' ? 'selected' : ''); ?>>Collège IT</option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if($errors->any()): ?>
        <?php if($errors->hasAny(['current_employer','employer_contact','current_position'])): ?>
            showStep(1);
        <?php elseif($errors->hasAny(['username','email','password'])): ?>
            showStep(2);
        <?php endif; ?>
    <?php endif; ?>
});
...
<?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/auth/membre-register.blade.php ENDPATH**/ ?>