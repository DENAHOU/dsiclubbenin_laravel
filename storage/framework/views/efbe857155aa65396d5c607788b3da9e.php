<?php $__env->startSection('title', 'Nos Formations'); ?>
        ...
        <section class="categories-section animated-section">
            <div class="container">
                ...
                <div class="categories-grid">
                    ...
                    <a href="#securite" class="category-card"><img src="<?php echo e(asset('img/OIP.webp')); ?>" alt=""><div class="category-card-content"><h3>Sécurité & Management SI</h3></div></a>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <section class="premium-section container">
                    ...
                    <div class="premium-grid">
                        <?php $__currentLoopData = $newFormations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="premium-card">
                            <?php if($formation->image_path): ?>
                                <img src="<?php echo e(asset('storage/' . $formation->image_path)); ?>" class="premium-img" alt="<?php echo e($formation->titre); ?>">
                            <?php else: ?>
                            ...
                            <div class="premium-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="badge bg-light text-dark"><?php echo e($formation->categoryFormation->nom ?? 'IT'); ?></span>
                                    <span class="premium-price"><?php echo e(number_format($formation->price, 0, ',', ' ')); ?> FCFA</span>
                                </div>
                                <h3 class="h4 fw-bold mb-3"><?php echo e($formation->titre); ?></h3>
                                <p class="text-white-50 small mb-4"><?php echo e(Str::limit($formation->description, 100)); ?></p>
                                
                                <div class="d-grid">
                                    <a href="<?php echo e(route('activites.formations.show', $formation->id)); ?>" class="btn btn-warning fw-bold py-2">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\club-dsi-laravel\resources\views/activites/formations.blade.php ENDPATH**/ ?>